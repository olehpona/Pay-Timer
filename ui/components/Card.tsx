...
export default function Card(props) {
    ...
    return (
        <>
            <div className="w-[80%] h-24 bg-gray-100 rounded-lg duration-200 flex justify-between items-center shadow-neo">
                ...
                <div className="grid grid-flow-col w-1/2 justify-items-stretch  items-center h-full">
                    <MainButton className=" h-[65%]"><Icon icon="tabler:map-pin" className="h-full"></Icon></MainButton>
                    <MainButton className=" h-[65%]"><Icon icon="tabler:clock-dollar" className="h-full"></Icon></MainButton>
                    {
                        props.editable && (<>
