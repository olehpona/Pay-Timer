    ...
    <div className="h-full w-full">
      <header className="bg-gray-100 shadow-neo w-full justify-between rounded-lg h-14 items-center flex">
        ...
        <div className="flex h-full items-center justify-center">
          <MainButton className="h-[65%]"><Icon icon={"tabler:calendar-plus"}></Icon></MainButton>
          <MainButton className="h-[65%]" onclick={() => { cardEdit ? setCardEdit(false) : setCardEdit(true) }}><Icon icon={"tabler:edit"}></Icon></MainButton>
        </div>
      </header>
